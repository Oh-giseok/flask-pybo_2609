...
from flask_wtf.file import FileField, file_allowed, FileAllowed
from wtforms.fields.simple import StringField, TextAreaField, SubmitField, PasswordField, EmailField, FileField
